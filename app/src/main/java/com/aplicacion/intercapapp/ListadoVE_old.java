...
public class ListadoVE_old extends ListActivity {
	...
	public void addComment(View v) {
		Intent i = new Intent(ListadoVE_old.this, AgregarDatos.class);
		startActivity(i);
	}
	...
	private void updateList() {
		...
		ListAdapter adapter = new SimpleAdapter(this, mCommentList,
				R.layout.item_ve, new String[] { TAG_TITLE, TAG_MESSAGE,
						TAG_USERNAME }, new int[] { R.id.nro_ve, R.id.descripcion,
						R.id.username });
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				TextView titulo = (TextView)findViewById(R.id.nro_ve);
				TextView mensaje = (TextView)findViewById(R.id.descripcion);
				...
				ReservaProducto.putExtra("tituloVe",titulo.getText().toString());
				ReservaProducto.putExtra("mensajeVe", mensaje.getText().toString());
	...
	public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ListadoVE_old.this);
