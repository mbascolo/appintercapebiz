...
public class Login_old extends Activity implements OnClickListener {
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Login_old.this);
			...
			try {
				...
				if (success == 1) {
					...
					SharedPreferences sp = PreferenceManager
							.getDefaultSharedPreferences(Login_old.this);
					Editor edit = sp.edit();
					edit.putString("username", username);
					edit.commit();
					
					Intent i = new Intent(Login_old.this, HomeActivity.class);
					finish();
					startActivity(i);
		...
		protected void onPostExecute(String file_url) {
			...
			if (file_url != null) {
				...
				Toast.makeText(Login_old.this, file_url, Toast.LENGTH_LONG).show();
			}
