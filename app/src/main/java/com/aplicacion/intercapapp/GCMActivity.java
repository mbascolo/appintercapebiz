...
public class GCMActivity extends AppCompatActivity {
    ...
    private static final String GCM_SENDER_ID = "872397807314";
    private static final String WEB_SERVER_URL = "http://www.intercap.com.ar/gcm3/register_user.php";
            ...
            public void onClick(View v) {
                ...
                if (isGoogelPlayInstalled()) {
                    ...
                    if (TextUtils.isEmpty(gcmRegId)) {
                        ...
                        Toast.makeText(getApplicationContext(), "Ya se ha registrado con GCM", Toast.LENGTH_SHORT).show();
                    }
                }
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                ...
                Toast.makeText(getApplicationContext(),
                        "Google Play Service no se encuentra instalado",
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                ...
                case MSG_REGISTER_WEB_SERVER_SUCCESS:
                    Toast.makeText(getApplicationContext(),
                            "Registrado con el servidor web", Toast.LENGTH_LONG).show();
                    break;
                case MSG_REGISTER_WEB_SERVER_FAILURE:
                    Toast.makeText(getApplicationContext(),
                            "Fallo en registro con el servidor web",
    ...
    private class GCMRegistrationTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result != null) {
                Toast.makeText(getApplicationContext(), "Registrado con GCM",
                        Toast.LENGTH_LONG).show();
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                if (status == 200) {
                    ...
                    throw new IOException("La petición ha fallado con el código de error "
                            + status);
                }
